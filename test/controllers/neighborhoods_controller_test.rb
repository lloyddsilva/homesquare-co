...
class NeighborhoodsControllerTest < ActionController::TestCase
  ...
  test "should create neighborhood" do
    assert_difference('Neighborhood.count') do
      post :create, neighborhood: { alias: @neighborhood.alias, city_id: @neighborhood.city_id, description: @neighborhood.description, name: @neighborhood.name, slug: @neighborhood.slug }
    end
  ...
  test "should update neighborhood" do
    patch :update, id: @neighborhood, neighborhood: { alias: @neighborhood.alias, city_id: @neighborhood.city_id, description: @neighborhood.description, name: @neighborhood.name, slug: @neighborhood.slug }
    assert_redirected_to neighborhood_path(assigns(:neighborhood))
  end
